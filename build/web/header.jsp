...
<header class="header bg-light border-bottom shadow-sm">
  <div class="container header-container d-flex justify-content-between align-items-center py-3">
    ...
    <div class="logo d-flex align-items-center">
      <a href="userhome#search" class="d-flex align-items-center text-decoration-none">
    ...
    <nav class="nav">
      <ul class="nav-list list-unstyled d-flex gap-4 mb-0">
        <li><a href="userhome#search" class="text-decoration-none text-dark fw-semibold">Search</a></li>
        <li><a href="userhome#order" class="text-decoration-none text-dark fw-semibold">Order</a></li>
        <li><a href="userhome#services" class="text-decoration-none text-dark fw-semibold">Services</a></li>
      </ul>
    </nav>
